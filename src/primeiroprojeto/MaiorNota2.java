...
public class MaiorNota2
{
    ...
    public static void main(String[] args)
    {
        ...
        if ((nota1 == nota2) && (nota1 == nota3))
        {
            ...
            if ((nota1 == nota2) && (nota1 > nota3))
                {System.out.println("As notas 1 e 2 sao maiores: \n" + nota1 + " e " + nota2);
                return;}
            if ((nota1 == nota3) && (nota1 > nota2))
                {System.out.println("As notas 1 e 3 sao maiores: \n" + nota1 + " e " + nota3);
                return;}
            if ((nota2 == nota3) && (nota2 > nota1))
                {System.out.println("As notas 2 e 3 sao maiores: \n" + nota2 + " e " + nota3);
                return;}
